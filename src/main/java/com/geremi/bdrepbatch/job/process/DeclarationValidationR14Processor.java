...
public class DeclarationValidationR14Processor implements ItemProcessor<String, List<Anomalie>>{
	...
	private static final Logger log = LoggerFactory.getLogger(DeclarationValidationR14Processor.class);
	...
	public List<Anomalie> process(String item) throws Exception {
		...
		listeIntermAnomalie.add(new AnomalieDTO(LocalDate.now(), CODE,
				String.format(LABEL, item), "declaration", "code_etablissement",item,
